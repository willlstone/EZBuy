...
<body>
    ...
    function get_results(){
      $(document).ready(function(){
        ...
        //Send keywords to amazon.php file
        //File generates signed url (required to use the app)
        //Returns an XML file containing product information
        $.post('amazon.php', x, function(data) {
          $(".results").append(data);
          AmazonsignedURL = data;
